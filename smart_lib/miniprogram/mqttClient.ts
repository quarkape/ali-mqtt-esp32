...
const host: string = 'mqtt-cn-zxu35xmti02.mqtt.aliyuncs.com'; // 设置当前用户的接入点域名，接入点获取方法请参考接入准备章节文档，先在控制台创建实例
...
const accessKey: string = 'LTAI5tLgZ2aZm3tciGvoh4TJ'; //账号的 AccessKey，在阿里云控制台查看
const secretKey: string = 'c1YcwZd7uwnFVCpRB0yABvl698MUUM'; //账号的的 SecretKey，在阿里云控制台查看
...
function connectMQTT() {
  const options = {
    ...
    clientId: clientId,
    username: username,
    password: 'A1DPJipY0TEK6iTNB2uydfj7Uzc=',
  }
